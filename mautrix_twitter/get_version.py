...
if os.path.exists(".git") and shutil.which("git"):
    try:
        ...
        git_revision_url = f"https://github.com/tulir/mautrix-twitter/commit/{git_revision}"
...
git_tag_url = (f"https://github.com/tulir/mautrix-twitter/releases/tag/{git_tag}"
