...
from mautrix_twitter.get_version import git_tag, git_revision, version, linkified_version
...
with open("mautrix_twitter/version.py", "w") as version_file:
...
setuptools.setup(
    ...
    version=version,
    url="https://github.com/tulir/mautrix-twitter",
