...
const (
	...
	ADD_XCHAT_PUBLIC_KEY_MUTATION_HASH = "vjZCP0G28pIJ6CUC99rdAQ"
	ADD_XCHAT_PUBLIC_KEY_MUTATION_URL  = API_BASE_URL + "/graphql/" + ADD_XCHAT_PUBLIC_KEY_MUTATION_HASH + "/AddXChatPublicKey"
